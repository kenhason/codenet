...
var _Questions = __webpack_require__(30);
...
var _Answer = __webpack_require__(32);

var _Answer2 = _interopRequireDefault(_Answer);

var _Question = __webpack_require__(33);
...
exports.Questions = _Questions2.default;
...
var Questions = function (_Component) {
    ...
    function Questions() {
        ...
        var _this = _possibleConstructorReturn(this, (Questions.__proto__ || Object.getPrototypeOf(Questions)).call(this));
    ...
    _createClass(Questions, [{
        ...
        value: function componentDidMount() {
            ...
            _APIManager2.default.get('/api/question', null, function (err, res) {
                if (err) {
                    alert("ERROR: " + error);
                    return;
                }
        ...
        value: function render() {
            var questions = this.state.questionList.map(function (question, i) {
                ...
                return _react2.default.createElement(
                    'div',
                    { key: i },
                    _react2.default.createElement(_.Question, { question: question })
                );
            });
